...
class Document {
     ...
     */
    public function __construct(int $id = null, string $document_serial_number = null, string $type = null,int $user_id = null,int $package_number = null, string $signature_base64 = null)
    {
        $this->id = $id;
