...
class HelperController {
    ...
    try {
        ...
        $mail->AddEmbeddedImage(HelperController::getDefaultDirectory()."resources/image/logo_douceur_de_chien.png", "logo-image", "logo_douceur_de_chien.png");
        $mail->Body = $body;
     ...
     * 
     * @param string $userResponseToken The user response token provided by the client-side integration.
    ...
    public static function getDefaultDirectory(){
        return $_SERVER["DOCUMENT_ROOT"]."/bj-travail-diplome-2021/api_rest/";
    }
}
